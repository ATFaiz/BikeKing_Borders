...
?>
      ...
      <br>
       ...
       <img  class="img-thumbnail img-rounded" width="400" hight="300" src="data:image/jpeg;base64, <?php echo base64_encode($rows[$record]['image']); ?>" 
    alt="<?php echo $rows[$record]['productName']; ?>">
    
    <h3><?php echo $rows[$record]['productName'];?></h3>

    <button style="color:black; background-color: chocolate; border: chocolate;padding-left: 30px; padding-right: 30px; " type="submit" class="btn btn-primary">
